...
function Recipedetail({recipe}) {
  ...
  return (
    <>
    <a href="/RecipeContainer" className="inline-flex items-center px-3 py-2  my-5 mx-10 text-sm font-medium text-center text-white bg-orange-500 rounded-lg hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-yellow-200 dark:bg-blue-600 dark:hover:bg-orange-400 dark:focus:ring-blue-800">
